...
local function CreateEchoesFrame()
    ...
    local calcConfigBtn = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    calcConfigBtn:SetSize(50, 18)
    calcConfigBtn:SetPoint("LEFT", calcLabel, "RIGHT", 6, 0)
    calcConfigBtn:SetText("Edit")
    calcConfigBtn:SetScript("OnClick", function()
        ToggleTooltipCalcConfig(f)
    end)
    calcConfigBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:AddLine("Configure AP/SP/Stamina values", 1, 1, 1)
        GameTooltip:AddLine("Set your Attack Power, Spell Power and Stamina\nfor tooltip formula calculations (Level 80).", 1, 0.82, 0, true)
        GameTooltip:Show()
    end)
