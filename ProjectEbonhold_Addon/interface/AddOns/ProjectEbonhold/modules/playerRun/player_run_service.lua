...
local function CheckIntensityThresholds(oldValue, newValue)
    ...
    local thresholds = {
        { level = 1, value = ProjectEbonhold.Constants.INTENSITY_LEVEL_1, name = "Intensity Level 1" },
